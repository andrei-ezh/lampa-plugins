(function () {
  ...
  var parserBase = [
    'jac.lampa32.ru',
    'https://gwynnbleiidd-jackett.elfhosted.com',
    'jacred.xyz',
    'jacred.ru',
    'jacred.viewbox.dev',
    'spawn.pp.ua:59118',
  ...
  function changeParser() {
    ...
    var parserSettings = {
      no_parser: { url: '', key: '' },
      jac_lampa32_ru: { url: 'jac.lampa32.ru', key: '' },
      spawn_jacred: { url: 'spawn.pp.ua:59118', key: '' },
      jacred_xyz: { url: 'jacred.xyz', key: '' },
      spawn_jackett: { url: 'spawn.pp.ua:59117', key: '2' },
      jacred_ru: { url: 'jacred.ru', key: '' },
      unknown: { url: '188.119.113.252:9117', key: '1' },
      jacred_viewbox_dev: { url: 'jacred.viewbox.dev', key: 'viewbox' }
    };
